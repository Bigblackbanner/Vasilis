<article class="kratos-hentry clearfix animate-box">
	...
	<div class="kratos-post-inner">
		<header class="kratos-entry-header clearfix">
			<h1 class="kratos-entry-title demo-2"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h1>
		...
		<p><?php echo $excerptphoto ?></p>
                  <div align="right"> <div class="col-xs-3">  <a  class="am-btn am-btn-success am-round"  href=”<?php the_permalink() ?>”><i class="am-icon-book"></i>阅读全文</a></div></div>
