...
<html class="no-js">
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/css/plus/anchorHoverEffect.css" rel="stylesheet" type="text/css">
	<link href="<?php echo get_template_directory_uri(); ?>/assets/css/amazeui.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/love.css">
					...
					<header id="kratos-header-section">
						<div class="container">
							<div class="nav-header">
								...
								<?php }?>
								<?php $defaults = array('theme_location' => 'header_menu', 'container' => 'nav', 'container_id' => 'kratos-menu-wrap', 'menu_class' => 'sf-menu demo-4', 'menu_id' => 'kratos-primary-menu', ); ?>
