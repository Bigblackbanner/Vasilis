...
<style type="text/css">
	.conten2t{width:80%;margin:200px auto;}
	...
	.shang_tit{width: 100%;height: 75px;text-align: center;line-height: 66px;color: #a3a3a3;font-size: 16px;background: url(<?php echo get_template_directory_uri(); ?>/img/cy-reward-title-bg.jpg);font-family: 'Microsoft YaHei';margin-top: 7px;margin-right:2px;}
	.shang_tit p{color:#a3a3a3;text-align:center;font-size:16px;}
	.shang_payimg{width:140px;padding:10px;border:6px solid #EA5F00;margin:0 auto;border-radius:3px;height:140px;}
	.shang_payimg img{display:block;text-align:center;width:140px;height:140px; }
	.pay_explain{text-align:center;margin:10px auto;font-size:12px;color:#545454;}
	.radiobox{width: 16px;height: 16px;background: url(<?php echo get_template_directory_uri(); ?>/img/radio2.jpg);display: block;float: left;margin-top: 5px;margin-right: 14px;}
	.checked .radiobox{background:url(<?php echo get_template_directory_uri(); ?>/img/radio1.jpg);}
...
<p><a href="javascript:void(0)" onClick="dashangToggle()" class="am-btn am-btn-danger" title="打赏，支持一下">打赏<i class="am-icon-diamond"></i></a></p>
